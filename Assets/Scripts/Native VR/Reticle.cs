...
namespace VRStandardAssets.Utils
{
    ...
    public class Reticle : MonoBehaviour
    {
        ...
        [SerializeField] private Sprite m_SpriteHitObject;
        ...
        private bool m_IsHitting;
        private bool m_IsProgressFull;
        ...
        private void Awake()
        {
            ...
            m_CurrentValue = 0.0f;
            m_IsHitting = false;
            m_IsProgressFull = false;
        }

        private void Update()
        {
            if (m_IsHitting && !m_IsProgressFull)
            {
                ...
                {
                    m_IsProgressFull = true;
                }
                m_Image.fillAmount = m_CurrentValue / 100;
            }
        }
        public void Hide()
        {
